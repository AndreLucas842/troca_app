...
const pool = mysql.createPool({
    ...
    user: process.env.DB_USER, // Usuario que fara a conexão 
    password: process.env.DB_PASSWORD, // Senha do usúario
    database: process.env.DB_NAME, // Banco ao qual deseja se conectar
    // Se todas conexões estiverem ocupadas, deixa o usúario esperando, sem dar erro 
...
// Exporta as informações do banco, pros models utilizarem,0
